...
export const metadata: Metadata = {
    ...
    description:
        "Choose the perfect plan for your needs. Simple, transparent pricing with a 14-day free trial on all plans.",
...
const PlanCard = ({
    ...
    >
        <Card
            className={`relative flex justify-between flex-col h-full
        ...
        >
            ...
            <CardHeader>
                ...
                <CardDescription className="flex items-baseline gap-1">
                    ...
                    <Text
                        variant="span"
                        className="text-gray-500 dark:text-gray-400 text-lg md:text-xl"
                        locale={locale}
                    >
                        /{t("month")}
                    </Text>
